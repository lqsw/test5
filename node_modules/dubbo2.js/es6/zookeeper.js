...
class ZkRegistry {
    constructor(props) {
        ...
        this._init = (err) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (let inf of interfaces) {
                ...
                //当前接口路径下的dubbo url
                const dubboServiceUrls = yield this._getDubboServiceUrls(dubboServicePath, inf);
                //init
    ...
    _getDubboServiceUrls(dubboServicePath, dubboInterface) {
        return __awaiter(this, void 0, void 0, function* () {
            const { res, err } = yield go_1.go(this._getChildren(dubboServicePath, this._watch(dubboServicePath, dubboInterface)));
            if (err) {
    ...
    _watch(dubboServicePath, dubboInterface) {
        ...
        return (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            const dubboServiceUrls = yield this._getDubboServiceUrls(dubboServicePath, dubboInterface);
